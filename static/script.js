    ...
    response = { 
      botResponse: `
        <div style="font-size: 1.2rem;">
          <p>Hello there! 🤖</p>
          <p>I'm your file assistant, here to assist you with any questions about your file's content. </p>
          <p>To upload a file, simply click the <i class='fa fa-upload' style='color:#125ee5'></i> icon located to the right of your message bar. We currently support files in .pdf, .doc, .docx, or .txt format.</p>
        </div>
      `
    };
    uploadButtonHtml = `
